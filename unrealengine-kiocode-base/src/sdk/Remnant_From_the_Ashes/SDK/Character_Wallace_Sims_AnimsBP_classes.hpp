...
// 0x2940 (0x33F0 - 0x0AB0)
class UCharacter_Wallace_Sims_AnimsBP_C final : public UAnimInstanceGunfire
{
public:
...
public:
	void ExecuteUbergraph_Character_Wallace_Sims_AnimsBP(int32 EntryPoint);
	void BlueprintUpdateAnimation(float DeltaTimeX);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Character_Wallace_Sims_AnimsBP_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Character_Wallace_Sims_AnimsBP_C")
	}
	static class UCharacter_Wallace_Sims_AnimsBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCharacter_Wallace_Sims_AnimsBP_C>();
	}
};
DUMPER7_ASSERTS_UCharacter_Wallace_Sims_AnimsBP_C;
