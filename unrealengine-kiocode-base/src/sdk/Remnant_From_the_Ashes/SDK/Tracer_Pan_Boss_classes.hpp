...
class ATracer_Pan_Boss_C final : public ATracer
{
public:
...
public:
	void ExecuteUbergraph_Tracer_Pan_Boss(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Tracer_Pan_Boss_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Tracer_Pan_Boss_C")
	}
	static class ATracer_Pan_Boss_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ATracer_Pan_Boss_C>();
	}
};
DUMPER7_ASSERTS_ATracer_Pan_Boss_C;
