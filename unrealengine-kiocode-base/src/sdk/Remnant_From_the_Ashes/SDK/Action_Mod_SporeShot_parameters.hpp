...
struct Action_Mod_SporeShot_C_ExecuteUbergraph_Action_Mod_SporeShot final
{
public:
	...
	float                                         CallFunc_GetDamage_Damage;                         // 0x0098(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_Cloud_Mod_SporeShot_C*              CallFunc_FinishSpawningActor_ReturnValue;          // 0x0158(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Action_Mod_SporeShot_C_ExecuteUbergraph_Action_Mod_SporeShot;

// Function Action_Mod_SporeShot.Action_Mod_SporeShot_C.GetDamage
// 0x0020 (0x0020 - 0x0000)
struct Action_Mod_SporeShot_C_GetDamage final
{
public:
	float                                         Damage;                                            // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetCause_ReturnValue;                     // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMod_SporeShot_C*                       K2Node_DynamicCast_AsMod_Spore_Shot;               // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetDOTDamage_Damage;                      // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_Action_Mod_SporeShot_C_GetDamage;

// Function Action_Mod_SporeShot.Action_Mod_SporeShot_C.GetPlayerAsCause
// 0x0050 (0x0050 - 0x0000)
struct Action_Mod_SporeShot_C_GetPlayerAsCause final
{
public:
...
DUMPER7_ASSERTS_Action_Mod_SporeShot_C_GetPlayerAsCause;
