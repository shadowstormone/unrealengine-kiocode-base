...
class UCharacter_Root_Rattleweed_C final : public UAnimInstanceGunfire
{
public:
...
public:
	void ExecuteUbergraph_Character_Root_Rattleweed(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Character_Root_Rattleweed_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Character_Root_Rattleweed_C")
	}
	static class UCharacter_Root_Rattleweed_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCharacter_Root_Rattleweed_C>();
	}
};
DUMPER7_ASSERTS_UCharacter_Root_Rattleweed_C;
