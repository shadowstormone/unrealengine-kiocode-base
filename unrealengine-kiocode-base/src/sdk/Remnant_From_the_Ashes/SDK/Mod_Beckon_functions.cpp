...
#include "Mod_Beckon_classes.hpp"
#include "Mod_Beckon_parameters.hpp"
...
void AMod_Beckon_C::ModifyInspectInfo(class AActor* Actor, class UItemInstanceData* InInstanceData, struct FInspectInfo& Info, bool* Rtn)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Mod_Beckon_C", "ModifyInspectInfo");

	Params::Mod_Beckon_C_ModifyInspectInfo Parms{};
...
float AMod_Beckon_C::GetSkullDamage()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Mod_Beckon_C", "GetSkullDamage");

	Params::Mod_Beckon_C_GetSkullDamage Parms{};
...
float AMod_Beckon_C::GetDuration()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Mod_Beckon_C", "GetDuration");

	Params::Mod_Beckon_C_GetDuration Parms{};
...
void AMod_Beckon_C::DoAction(class UActionComponent* ActionComponent, int32* ActionID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Mod_Beckon_C", "DoAction");

	Params::Mod_Beckon_C_DoAction Parms{};
...
void AMod_Beckon_C::GetSkullHealthScalar(float* Out)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Mod_Beckon_C", "GetSkullHealthScalar");

	Params::Mod_Beckon_C_GetSkullHealthScalar Parms{};
