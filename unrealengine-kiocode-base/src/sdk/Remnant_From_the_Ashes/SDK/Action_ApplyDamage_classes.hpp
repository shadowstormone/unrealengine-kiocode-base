...
class UAction_ApplyDamage_C final : public UActionBase
{
public:
...
public:
	void ExecuteUbergraph_Action_ApplyDamage(int32 EntryPoint);
	void OnActionStart();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Action_ApplyDamage_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Action_ApplyDamage_C")
	}
	static class UAction_ApplyDamage_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAction_ApplyDamage_C>();
	}
};
DUMPER7_ASSERTS_UAction_ApplyDamage_C;
