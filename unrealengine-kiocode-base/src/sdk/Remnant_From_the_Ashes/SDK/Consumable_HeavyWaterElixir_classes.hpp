...
class AConsumable_HeavyWaterElixir_C final : public AItem_Potion_Base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Consumable_HeavyWaterElixir_C;      // 0x0630(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Consumable_HeavyWaterElixir(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Consumable_HeavyWaterElixir_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Consumable_HeavyWaterElixir_C")
	}
	static class AConsumable_HeavyWaterElixir_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AConsumable_HeavyWaterElixir_C>();
	}
};
DUMPER7_ASSERTS_AConsumable_HeavyWaterElixir_C;
