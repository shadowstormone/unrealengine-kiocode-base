...
struct FStatDef_MeleeWeapon final
{
public:
	int32                                         Value_13_C4B0470D4B0B7CC9FA79699B35CB2B7A;         // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_FStatDef_MeleeWeapon;
