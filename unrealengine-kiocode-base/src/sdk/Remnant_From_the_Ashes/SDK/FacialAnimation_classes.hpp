...
{
public:
	class FName                                   CurveSourceBindingName;                            // 0x0770(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_77C[0x34];                                     // 0x077C(0x0034)(Fixing Struct Size After Last Property [ Dumper-7 ])
