...
class UAction_Root_Cloud_DOT_C final : public UAction_DOT_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Action_Root_Cloud_DOT_C;            // 0x02F0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Action_Root_Cloud_DOT(int32 EntryPoint);
	void OnActionStop();
	void OnActionStart();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Action_Root_Cloud_DOT_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Action_Root_Cloud_DOT_C")
	}
	static class UAction_Root_Cloud_DOT_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAction_Root_Cloud_DOT_C>();
	}
};
DUMPER7_ASSERTS_UAction_Root_Cloud_DOT_C;
