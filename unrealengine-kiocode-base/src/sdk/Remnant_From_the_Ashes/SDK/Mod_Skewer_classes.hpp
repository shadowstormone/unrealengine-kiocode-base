...
class AMod_Skewer_C final : public ARangedWeapon_Mod_WeaponMode_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mod_Skewer_C;                       // 0x0710(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mod_Skewer(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Mod_Skewer_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Mod_Skewer_C")
	}
	static class AMod_Skewer_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AMod_Skewer_C>();
	}
};
DUMPER7_ASSERTS_AMod_Skewer_C;
