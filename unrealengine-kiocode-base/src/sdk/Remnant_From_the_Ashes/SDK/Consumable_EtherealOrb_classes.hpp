...
class AConsumable_EtherealOrb_C final : public AItem_Potion_Base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Consumable_EtherealOrb_C;           // 0x0630(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Consumable_EtherealOrb(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Consumable_EtherealOrb_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Consumable_EtherealOrb_C")
	}
	static class AConsumable_EtherealOrb_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AConsumable_EtherealOrb_C>();
	}
};
DUMPER7_ASSERTS_AConsumable_EtherealOrb_C;
