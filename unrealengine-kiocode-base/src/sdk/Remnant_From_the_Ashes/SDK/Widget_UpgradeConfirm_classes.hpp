...
class UWidget_UpgradeConfirm_C final : public UWidget_UserWidget_C
{
public:
	uint8                                         Pad_249[0x7];                                      // 0x0249(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerToUberGraphFrame               UberGraphFrame_Widget_UpgradeConfirm_C;            // 0x0250(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Widget_UpgradeConfirm(int32 EntryPoint);
	...
	void Init(int32 ItemID, const struct FRecipeInfo& RecipeInfo_0);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Widget_UpgradeConfirm_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_UpgradeConfirm_C")
	}
	static class UWidget_UpgradeConfirm_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_UpgradeConfirm_C>();
	}
};
DUMPER7_ASSERTS_UWidget_UpgradeConfirm_C;
