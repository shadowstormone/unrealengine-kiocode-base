...
class UWeapon_Pan_EyeOfTheStorm_AnimsBP_C final : public UAnimInstanceGunfire
{
public:
...
public:
	void ExecuteUbergraph_Weapon_Pan_EyeOfTheStorm_AnimsBP(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Weapon_Pan_EyeOfTheStorm_AnimsBP_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Weapon_Pan_EyeOfTheStorm_AnimsBP_C")
	}
	static class UWeapon_Pan_EyeOfTheStorm_AnimsBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWeapon_Pan_EyeOfTheStorm_AnimsBP_C>();
	}
};
DUMPER7_ASSERTS_UWeapon_Pan_EyeOfTheStorm_AnimsBP_C;
