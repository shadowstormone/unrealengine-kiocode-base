...
public:
	...
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                   // 0x0338(0x0050)(Edit, ZeroConstructor, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)
