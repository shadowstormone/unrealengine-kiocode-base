...
class UWidget_ResolutionUserSetting_C final : public UFocusWidget
{
public:
...
public:
	void ExecuteUbergraph_Widget_ResolutionUserSetting(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Widget_ResolutionUserSetting_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_ResolutionUserSetting_C")
	}
	static class UWidget_ResolutionUserSetting_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_ResolutionUserSetting_C>();
	}
};
DUMPER7_ASSERTS_UWidget_ResolutionUserSetting_C;
