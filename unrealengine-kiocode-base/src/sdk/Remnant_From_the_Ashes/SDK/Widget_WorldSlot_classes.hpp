...
class UWidget_WorldSlot_C final : public UFocusWidget
{
public:
	...
	class UFocusVisual*                           FocusVisual_0;                                     // 0x0310(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_38;                                    // 0x0318(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                 Image_165;                                         // 0x0368(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	int32                                         SlotID;                                            // 0x03A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	UMulticastDelegateProperty_                   OnCreate;                                          // 0x03A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                   OnSelect;                                          // 0x03B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class FText                                   QuestModeLabel;                                    // 0x03C8(0x0018)(Edit, BlueprintVisible)
	class FText                                   QuestModeDescription;                              // 0x03E0(0x0018)(Edit, BlueprintVisible)
	...
	class FText                                   QuestModePrompt;                                   // 0x0400(0x0018)(Edit, BlueprintVisible)
...
public:
	void ExecuteUbergraph_Widget_WorldSlot(int32 EntryPoint);
	...
	void SetGameMode(const class FText& Label, const class FText& Description, class UTexture2D* Icon);
	ESlateVisibility Get_Create_Visibility_0();
	void GetPrompt(class FText* Out);
	ESlateVisibility Get_ActivePanel_Visibility_0();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Widget_WorldSlot_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_WorldSlot_C")
	}
	static class UWidget_WorldSlot_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_WorldSlot_C>();
	}
};
DUMPER7_ASSERTS_UWidget_WorldSlot_C;
