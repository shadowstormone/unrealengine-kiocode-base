...
class AMod_SporeShot_C final : public ARangedWeapon_Mod_WeaponMode_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mod_SporeShot_C;                    // 0x0710(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mod_SporeShot(int32 EntryPoint);
	...
	void GetDoTDamage(float* Damage_0);
	void GetSporeCloudDuration(float* Duration_0);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Mod_SporeShot_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Mod_SporeShot_C")
	}
	static class AMod_SporeShot_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AMod_SporeShot_C>();
	}
};
DUMPER7_ASSERTS_AMod_SporeShot_C;
