...
class AMod_SporeShot_Projectile_C final : public AProjectileSphere
{
public:
...
public:
	void ExecuteUbergraph_Mod_SporeShot_Projectile(int32 EntryPoint);
	void OnProjectileHit(const struct FHitResult& Hit);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Mod_SporeShot_Projectile_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Mod_SporeShot_Projectile_C")
	}
	static class AMod_SporeShot_Projectile_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AMod_SporeShot_Projectile_C>();
	}
};
DUMPER7_ASSERTS_AMod_SporeShot_Projectile_C;
