...
class UAction_Mod_WildfireShot_C final : public UBP_ActionBase_C
{
public:
...
public:
	void ExecuteUbergraph_Action_Mod_WildfireShot(int32 EntryPoint);
	void OnActionStart();
	void ReadValues();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Action_Mod_WildfireShot_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Action_Mod_WildfireShot_C")
	}
	static class UAction_Mod_WildfireShot_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAction_Mod_WildfireShot_C>();
	}
};
DUMPER7_ASSERTS_UAction_Mod_WildfireShot_C;
