...
class UTrait_RapidStrike_C final : public UBP_RemnantTrait_C
{
public:
...
public:
	void ExecuteUbergraph_Trait_RapidStrike(int32 EntryPoint);
	void OnComputeStats();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Trait_RapidStrike_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Trait_RapidStrike_C")
	}
	static class UTrait_RapidStrike_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTrait_RapidStrike_C>();
	}
};
DUMPER7_ASSERTS_UTrait_RapidStrike_C;
