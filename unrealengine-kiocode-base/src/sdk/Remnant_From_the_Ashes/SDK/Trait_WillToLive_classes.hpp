...
class UTrait_WillToLive_C final : public UBP_RemnantTrait_C
{
public:
...
public:
	void ExecuteUbergraph_Trait_WillToLive(int32 EntryPoint);
	void OnComputeStats();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Trait_WillToLive_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Trait_WillToLive_C")
	}
	static class UTrait_WillToLive_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTrait_WillToLive_C>();
	}
};
DUMPER7_ASSERTS_UTrait_WillToLive_C;
