...
class UTrait_Invoker_C final : public UBP_RemnantTrait_C
{
public:
...
public:
	void ExecuteUbergraph_Trait_Invoker(int32 EntryPoint);
	void OnComputeStats();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Trait_Invoker_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Trait_Invoker_C")
	}
	static class UTrait_Invoker_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTrait_Invoker_C>();
	}
};
DUMPER7_ASSERTS_UTrait_Invoker_C;
