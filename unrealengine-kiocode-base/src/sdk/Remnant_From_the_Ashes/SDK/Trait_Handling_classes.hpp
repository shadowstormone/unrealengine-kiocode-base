...
class UTrait_Handling_C final : public UBP_RemnantTrait_C
{
public:
...
public:
	void ExecuteUbergraph_Trait_Handling(int32 EntryPoint);
	void OnComputeStats();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Trait_Handling_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Trait_Handling_C")
	}
	static class UTrait_Handling_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTrait_Handling_C>();
	}
};
DUMPER7_ASSERTS_UTrait_Handling_C;
