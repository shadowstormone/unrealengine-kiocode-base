...
class AMod_HiveShot_C final : public ARangedWeapon_Mod_WeaponMode_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mod_HiveShot_C;                     // 0x0710(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mod_HiveShot(int32 EntryPoint);
	...
	void GetHiveShotCloudDuration(float* Duration_0);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Mod_HiveShot_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Mod_HiveShot_C")
	}
	static class AMod_HiveShot_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AMod_HiveShot_C>();
	}
};
DUMPER7_ASSERTS_AMod_HiveShot_C;
