...
class UWidget_ZoneEntering_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_Widget_ZoneEntering(int32 EntryPoint);
	void Destruct();
	void Construct();
	void Show(const class FText& ZoneName, const class FText& WorldName_0, float Duration_0);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Widget_ZoneEntering_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_ZoneEntering_C")
	}
	static class UWidget_ZoneEntering_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_ZoneEntering_C>();
	}
};
DUMPER7_ASSERTS_UWidget_ZoneEntering_C;
