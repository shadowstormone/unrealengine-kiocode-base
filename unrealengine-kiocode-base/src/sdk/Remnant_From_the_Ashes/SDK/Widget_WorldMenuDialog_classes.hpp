...
class UWidget_WorldMenuDialog_C final : public UUserWidget
{
public:
	...
	class UFocusButtonWidget*                     FocusButtonWidget_0;                               // 0x02E0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusButtonWidget*                     FocusButtonWidget_1;                               // 0x02E8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_0;                                     // 0x02F0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_1;                                     // 0x02F8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_536;                                   // 0x0300(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_538;                                   // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_539;                                   // 0x0310(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_540;                                   // 0x0318(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UFocusVisual*                           FocusVisual_541;                                   // 0x0320(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                 Image_67;                                          // 0x0378(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_73;                                          // 0x0380(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                 Image_402;                                         // 0x0398(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class URetainerBox*                           RetainerBox_4;                                     // 0x03B0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UTextBlock*                             TextBlock_0;                                       // 0x0420(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UTextBlock*                             TextBlock_2;                                       // 0x0430(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWidget_ButtonEx_C*                     Widget_ButtonEx_C_1;                               // 0x0438(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWidget_WorldSlot_C*                    Widget_WorldSlot_C_0;                              // 0x0440(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	int32                                         CurrentSlot;                                       // 0x0468(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         AvailableQuestIdx;                                 // 0x0480(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Difficulty;                                        // 0x0484(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TMap<EQuestMode, class FName>                 DifficultyDescriptionRowMap;                       // 0x04A0(0x0050)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)

public:
	void ExecuteUbergraph_Widget_WorldMenuDialog(int32 EntryPoint);
	...
	void BndEvt__Slot2_K2Node_ComponentBoundEvent_5_OnCreate__DelegateSignature(class UWidget_WorldSlot_C* Slot_0);
	...
	void BndEvt__Slot2_K2Node_ComponentBoundEvent_3_OnCreate__DelegateSignature(class UWidget_WorldSlot_C* Slot_0);
	void BndEvt__Slot1_K2Node_ComponentBoundEvent_2_OnCreate__DelegateSignature(class UWidget_WorldSlot_C* Slot_0);
	void BndEvt__Slot0_K2Node_ComponentBoundEvent_1_OnCreate__DelegateSignature(class UWidget_WorldSlot_C* Slot_0);
	void EndDialog();
	...
	void Construct();
	void BndEvt__SurvivalDifficultyApocalypse_K2Node_ComponentBoundEvent_26_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__SurvivalDifficultyNightmare_K2Node_ComponentBoundEvent_25_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__SurvivalDifficultyHard_K2Node_ComponentBoundEvent_24_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__SurvivalDifficultyNormal_K2Node_ComponentBoundEvent_23_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__Widget_DifficultyTab_C_3_K2Node_ComponentBoundEvent_22_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__Widget_DifficultyTab_C_2_K2Node_ComponentBoundEvent_21_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__Widget_DifficultyTab_C_1_K2Node_ComponentBoundEvent_18_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__Widget_DifficultyTab_C_0_K2Node_ComponentBoundEvent_17_OnSelected__DelegateSignature(int32 Difficulty_0);
	...
	void BndEvt__DifficultyApocalipse_K2Node_ComponentBoundEvent_20_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__DifficultyApocalipse_K2Node_ComponentBoundEvent_19_OnFocused__DelegateSignature(int32 Difficulty_0);
	...
	void BndEvt__DifficultyNightmare_K2Node_ComponentBoundEvent_15_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__DifficultyHard_K2Node_ComponentBoundEvent_14_OnSelected__DelegateSignature(int32 Difficulty_0);
	void BndEvt__DifficultyNormal_K2Node_ComponentBoundEvent_13_OnSelected__DelegateSignature(int32 Difficulty_0);
	...
	void BndEvt__DifficultyNightmare_K2Node_ComponentBoundEvent_11_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__DifficultyHard_K2Node_ComponentBoundEvent_10_OnFocused__DelegateSignature(int32 Difficulty_0);
	void BndEvt__DifficultyNormal_K2Node_ComponentBoundEvent_9_OnFocused__DelegateSignature(int32 Difficulty_0);
	...
	void GetQuest(int32 Slot_0, class ARemnantQuest** Quest);
	void RefreshQuestSlots();
	void RefreshCreateQuest();
	void BeginCreateQuest(const class FText& CreateBtnLabel);
	void BuildCreateQuestList();
	void PrevQuest();
	void NextQuest();
	ESlateVisibility Get_QuestSelectRight_Visibility_0();
	ESlateVisibility Get_CreateNewWorld_Visibility_0();
	bool Get_Select_bIsEnabled_0();
	void LoadQuestAndClose(int32 Slot_0);
	void RefreshCreateButton();
	ESlateVisibility Get_QuestSelectLeft_Visibility_0();
	void BeginSelectDifficulty();
	ESlateVisibility Get_Slot2_Visibility_0();
	void FocusCurrentSlot();
	void GetCreateCaptionForGameMode(class FText* Caption);
	void GetDescriptionRowFromGameMode(EQuestMode QuestMode, class FName* RowName);
	void GetDescriptionTextFromDifficulty(int32 Difficulty_0, const struct FStruct_DifficultyDescription& DescriptionStruct, class FText* OutText);
	void BeginSurvivalMode();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Widget_WorldMenuDialog_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_WorldMenuDialog_C")
	}
	static class UWidget_WorldMenuDialog_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_WorldMenuDialog_C>();
	}
};
DUMPER7_ASSERTS_UWidget_WorldMenuDialog_C;
