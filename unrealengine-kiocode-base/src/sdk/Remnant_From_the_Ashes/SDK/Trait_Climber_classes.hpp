...
class UTrait_Climber_C final : public UBP_RemnantTrait_C
{
public:
...
public:
	void ExecuteUbergraph_Trait_Climber(int32 EntryPoint);
	void OnComputeStats();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Trait_Climber_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Trait_Climber_C")
	}
	static class UTrait_Climber_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTrait_Climber_C>();
	}
};
DUMPER7_ASSERTS_UTrait_Climber_C;
