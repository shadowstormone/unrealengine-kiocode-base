...
// 0x1908 (0x23E0 - 0x0AD8)
class UCharacter_Wasteland_VeryGoodBoy_AnimsBP_C final : public URemnantAnimInstance
{
public:
...
public:
	void ExecuteUbergraph_Character_Wasteland_VeryGoodBoy_AnimsBP(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Character_Wasteland_VeryGoodBoy_AnimsBP_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Character_Wasteland_VeryGoodBoy_AnimsBP_C")
	}
	static class UCharacter_Wasteland_VeryGoodBoy_AnimsBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCharacter_Wasteland_VeryGoodBoy_AnimsBP_C>();
	}
};
DUMPER7_ASSERTS_UCharacter_Wasteland_VeryGoodBoy_AnimsBP_C;
