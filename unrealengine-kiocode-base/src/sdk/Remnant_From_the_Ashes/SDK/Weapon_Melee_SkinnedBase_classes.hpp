...
public:
	void GetWeaponDamageScalar(bool Inspecting_0, float* Out);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Weapon_Melee_SkinnedBase_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Weapon_Melee_SkinnedBase_C")
	}
	static class AWeapon_Melee_SkinnedBase_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AWeapon_Melee_SkinnedBase_C>();
	}
};
DUMPER7_ASSERTS_AWeapon_Melee_SkinnedBase_C;
