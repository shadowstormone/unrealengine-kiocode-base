...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Interactive_DragonCrystal_C;        // 0x03C8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	int32                                         GrabCounter;                                       // 0x04B4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ARemnantCharacter*                      PendingOverlapPlayer_0;                            // 0x04B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void ExecuteUbergraph_Interactive_DragonCrystal(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Interactive_DragonCrystal_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Interactive_DragonCrystal_C")
	}
	static class AInteractive_DragonCrystal_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AInteractive_DragonCrystal_C>();
	}
};
DUMPER7_ASSERTS_AInteractive_DragonCrystal_C;
