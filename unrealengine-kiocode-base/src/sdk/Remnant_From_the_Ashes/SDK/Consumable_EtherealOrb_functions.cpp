...
#include "Consumable_EtherealOrb_classes.hpp"
#include "Consumable_EtherealOrb_parameters.hpp"
...
void AConsumable_EtherealOrb_C::ExecuteUbergraph_Consumable_EtherealOrb(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Consumable_EtherealOrb_C", "ExecuteUbergraph_Consumable_EtherealOrb");

	Params::Consumable_EtherealOrb_C_ExecuteUbergraph_Consumable_EtherealOrb Parms{};
...
void AConsumable_EtherealOrb_C::DoAction(class UActionComponent* ActionComponent, class AActor* Cause, class AActor* Target)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Consumable_EtherealOrb_C", "DoAction");

	Params::Consumable_EtherealOrb_C_DoAction Parms{};
...
void AConsumable_EtherealOrb_C::ModifyInspectInfo(class AActor* Actor, class UItemInstanceData* InInstanceData, struct FInspectInfo& Info, bool* Rtn)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Consumable_EtherealOrb_C", "ModifyInspectInfo");

	Params::Consumable_EtherealOrb_C_ModifyInspectInfo Parms{};
