...
class UWidget_EquipmentSlot_Large_C final : public UWidget_EquipmentSlot_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Widget_EquipmentSlot_Large_C;       // 0x0370(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Widget_EquipmentSlot_Large(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Widget_EquipmentSlot_Large_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_EquipmentSlot_Large_C")
	}
	static class UWidget_EquipmentSlot_Large_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_EquipmentSlot_Large_C>();
	}
};
DUMPER7_ASSERTS_UWidget_EquipmentSlot_Large_C;
