...
class AInteractive_Waypoint_C final : public AActor
{
public:
	...
	int32                                         GrabCounter;                                       // 0x0424(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_Interactive_Waypoint(int32 EntryPoint);
	...
	void BndEvt__StateMachine_K2Node_ComponentBoundEvent_1_StateChangeDelegate__DelegateSignature(const class FName& StateName, const class FName& PreviousStateName);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Interactive_Waypoint_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Interactive_Waypoint_C")
	}
	static class AInteractive_Waypoint_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AInteractive_Waypoint_C>();
	}
};
DUMPER7_ASSERTS_AInteractive_Waypoint_C;
