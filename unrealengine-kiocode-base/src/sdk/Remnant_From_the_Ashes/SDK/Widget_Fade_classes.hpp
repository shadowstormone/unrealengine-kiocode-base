...
class UWidget_Fade_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_Widget_Fade(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Widget_Fade_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_Fade_C")
	}
	static class UWidget_Fade_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_Fade_C>();
	}
};
DUMPER7_ASSERTS_UWidget_Fade_C;
