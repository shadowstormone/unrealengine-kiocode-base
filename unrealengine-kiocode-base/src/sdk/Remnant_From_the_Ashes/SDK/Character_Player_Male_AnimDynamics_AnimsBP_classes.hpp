...
class UCharacter_Player_Male_AnimDynamics_AnimsBP_C final : public UAnimInstanceGunfire
{
public:
...
public:
	void ExecuteUbergraph_Character_Player_Male_AnimDynamics_AnimsBP(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Character_Player_Male_AnimDynamics_AnimsBP_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Character_Player_Male_AnimDynamics_AnimsBP_C")
	}
	static class UCharacter_Player_Male_AnimDynamics_AnimsBP_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCharacter_Player_Male_AnimDynamics_AnimsBP_C>();
	}
};
DUMPER7_ASSERTS_UCharacter_Player_Male_AnimDynamics_AnimsBP_C;
