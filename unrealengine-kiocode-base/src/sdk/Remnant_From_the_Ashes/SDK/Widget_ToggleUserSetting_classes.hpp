...
class UWidget_ToggleUserSetting_C final : public UFocusWidget
{
public:
...
public:
	void ExecuteUbergraph_Widget_ToggleUserSetting(int32 EntryPoint);
	void Construct();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Widget_ToggleUserSetting_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_ToggleUserSetting_C")
	}
	static class UWidget_ToggleUserSetting_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_ToggleUserSetting_C>();
	}
};
DUMPER7_ASSERTS_UWidget_ToggleUserSetting_C;
