...
class AWeapon_RepeaterPistol_C final : public AWeapon_HandGun_Base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Weapon_RepeaterPistol_C;            // 0x0CD0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Weapon_RepeaterPistol(int32 EntryPoint);
	void OnActivated();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("Weapon_RepeaterPistol_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Weapon_RepeaterPistol_C")
	}
	static class AWeapon_RepeaterPistol_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AWeapon_RepeaterPistol_C>();
	}
};
DUMPER7_ASSERTS_AWeapon_RepeaterPistol_C;
