...
class UWidget_VoiceInputDeviceUserSetting_C final : public UFocusWidget
{
public:
...
public:
	void ExecuteUbergraph_Widget_VoiceInputDeviceUserSetting(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Widget_VoiceInputDeviceUserSetting_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Widget_VoiceInputDeviceUserSetting_C")
	}
	static class UWidget_VoiceInputDeviceUserSetting_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWidget_VoiceInputDeviceUserSetting_C>();
	}
};
DUMPER7_ASSERTS_UWidget_VoiceInputDeviceUserSetting_C;
